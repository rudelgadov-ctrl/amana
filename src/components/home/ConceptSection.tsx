...
const ConceptSection = () => {
  ...
  return <section className="py-24 bg-eggshell">
      <div className="container mx-auto px-4 lg:px-8">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4 bg-[#dad8c8]">
        ...
        <div className="flex justify-center mb-12">
          <Button asChild className="border-2 border-blueberry bg-transparent text-blueberry hover:bg-cta hover:text-cta-foreground hover:border-cta font-body font-medium px-10 py-6 text-lg transition-all duration-300">
            <Link to="/menu">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {cards.map((card, index) => <Link key={index} to={card.href} className="group">
