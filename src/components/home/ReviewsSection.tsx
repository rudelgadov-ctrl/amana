...
const ReviewsSection = () => {
  ...
  return <section className="py-24 bg-[#dad8c8]">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-4">
              {reviews.map(review => <CarouselItem key={review.id} className="pl-4 md:basis-1/2 lg:basis-1/2">
                  <Card className="h-full border-0 bg-eggshell shadow-md">
                    ...
                    }).map((_, i) => <Star key={i} size={20} className="text-yolk fill-yolk" />)}
                      </div>
