...
const CTASection = () => {
  ...
  return <section className="py-12 sm:py-16 md:py-24 bg-blueberry relative overflow-hidden">
      {/* Decorative elements */}
        ...
        <ScrollAnimation animation="fade-up">
          <div className="max-w-3xl mx-auto text-center space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-2 sm:pt-4 px-4 sm:px-0">
              <Button asChild className="border-2 border-eggshell bg-transparent text-eggshell hover:bg-cta hover:text-cta-foreground hover:border-cta font-body font-medium px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 text-base sm:text-lg transition-all duration-300">
              ...
              <Button asChild variant="outline" className="border-asparagus text-asparagus hover:bg-asparagus/10 hover:text-eggshell font-body px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 text-base sm:text-lg">
